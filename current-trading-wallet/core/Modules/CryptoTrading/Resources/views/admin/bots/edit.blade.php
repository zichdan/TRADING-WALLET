<div class="general-form edit-form  hidden">
    {{-- {{ dd($errors->all()) }} --}}
                    ...
                    <form class="mt-2 p-2 md:p-4" action="{{ route('admin.trading.trading-bots.create') }}"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="w-full md:flex md:justify-space-around">
                            <div class="text-[#bfc9d4] text-xs md:text-sm p-2">
                                <div class="w-full">
                                    <label class="font-medium" for="e_name">Name:</label>
                                    <input class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500" type="text" name="name" id="e_name" value="{{ old('name') }}" required>
                                </div>

    ...
    <div class="w-full flex justify-center">
        <div class="w-11/12 rounded-sm bg-[#0e1726] p-1 md:p-4">
            ...
            <div class="p-2 md:p-4">
                <form class="mt-2 p-2 md:p-4" action="{{ route('admin.testimonials.new') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-[#bfc9d4] text-xs md:text-sm">
                        <div class="w-full">
                            <label class="font-medium" for="star_rating">Rating: <span id="rating"></span></label>
                            <input class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500" type="range" min="1" max="5" step="0.1" name="star_rating" id="star_rating" value="{{ old('star_rating') }}" required>
                        </div>
                        <span class="p-1 text-red-600">
                    ...
                    <div class="text-[#bfc9d4] text-xs md:text-sm">
                        <div class="w-full">
                            ...
                            <textarea class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500" name="comment" id="comment" required>{!! old('comment') !!}</textarea>
                        </div>
                        <span class="p-1 text-red-600">
                        ...
                        <div class="w-full flex items-center space-x-2">
                            ...
                            <div class="lg:flex-grow lg:flex items-center space-x-2">
                                <div class="w-full lg:w-1/3">
                                    ...
                                    <input class="hidden attachment-input" type="file" name="photo" id="photo" accept="image/png, image/jpg, image/jpeg" required>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        var initial = $("#star_rating").val();
        jQuery("#rating").html(initial);
    });

    ...
    <div class="w-full flex justify-center">
        <div class="w-11/12 rounded-sm bg-[#0e1726] p-1 md:p-4">
            ...
            <div class="p-2 md:p-4">
                <form class="mt-2 p-2 md:p-4" action="{{ route('admin.faqs.edit', $faq->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-[#bfc9d4] text-xs md:text-sm">
                        <div class="w-full">
                            ...
                            <input class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500" type="text" name="question" id="question" value="{{ old('question') ?? $faq->question }}" required>
                        </div>
                    ...
                    <div class="text-[#bfc9d4] text-xs md:text-sm">
                        <div class="w-full">
                            ...
                            <textarea class="w-full pt-2 bg-[#0e1726] transition-colors duration-200 transform focus:outline-none border-b-2 border-slate-800 focus:border-b-slate-500" name="answer" id="answer">{!! old('answer') ?? $faq->answer !!}</textarea>
                        </div>
                        <span class="p-1 text-red-600">

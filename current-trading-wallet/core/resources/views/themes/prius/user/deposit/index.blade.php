            ...
            <div class="w-full py-5">
                <div class="w-full lg:flex lg:justify-evenly lg:space-x-2 space-y-3 lg:space-y-0 text-[#bfc9d4]">
                    <div class="flex lg:block justify-between items-center bg-[#152136] px-3 lg:px-5 py-2 lg:py-3 hover:text-white cursor-pointer rounded-md">
                        ...
                        <div>
                            <div>
                                <h2 class="text-sm lg:text-base font-semibold">{{ formatAmount($total_deposits_value) }}</h2>
                            </div>
                            <div class="mt-2">
                                <h4 class="text-xs lg:text-sm font-medium">{{ ct('Total deposits') }}</h4>
                            </div>
                        </div>
                    ...
                    <div class="flex lg:block justify-between items-center bg-[#152136] px-3 lg:px-5 py-2 lg:py-3 hover:text-white cursor-pointer rounded-md">
                        ...
                        <div>
                            <div>
                                <h2 class="text-sm lg:text-base font-semibold">{{ formatAmount($pending_deposits_value) }}</h2>
                            </div>
                            <div class="mt-2">
                                <h4 class="text-xs lg:text-sm font-medium">{{ ct('Pending deposits') }}</h4>
                            </div>
                        </div>
                        <div class="lg:hidden opacity-50">
                    ...
                    <div class="flex lg:block justify-between items-center bg-[#152136] px-3 lg:px-5 py-2 lg:py-3 hover:text-white cursor-pointer rounded-md">
                        ...
                        <div>
                            <div>
                                <h2 class="text-sm lg:text-base font-semibold">{{ formatAmount($approved_deposits_value) }}</h2>
                            </div>
                            <div class="mt-2">
                                <h4 class="text-xs lg:text-sm font-medium">{{ ct('Approved deposits') }}</h4>
                            </div>
                        </div>
                        <div class="lg:hidden opacity-50">
                    ...
                    <div class="flex lg:block justify-between items-center bg-[#152136] px-3 lg:px-5 py-2 lg:py-3 hover:text-white cursor-pointer rounded-md">
                        ...
                        <div>
                            <div>
                                <h2 class="text-sm lg:text-base font-semibold">{{ formatAmount($rejected_deposits_value) }}</h2>
                            </div>
                            <div class="mt-2">
                                <h4 class="text-xs lg:text-sm font-medium">{{ ct('Rejected deposits') }}</h4>
                            </div>
                        </div>
                        <div class="lg:hidden opacity-50">
            ...
            @else 
                ...
                <div class="w-full p-6 md:p-10 flex justify-center">
                    <div class="w-full flex space-x-2 rounded-lg bg-[#131d2c] text-[#d3d6df] p-2 md:p-4 text-xs md:text-sm">
                        ...
                        <div>
                            <b class="font-medium">{{ ct('Empty Record!') }} </b> {{ ct("You haven't made any deposit yet") }}.
                        </div>
                    </div>
                </div> 
            @endif

                        ...
                        <table id="datatable-skeleton-table" class="text-[#bfc9d4] text-xs md:text-sm">
                            ...
                            <tbody width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.trading.wallets.view', $currency->address) }}" class="create-wallet-btn flex justify-start items-center space-x-1 text-xs md:text-sm text-[#d1d5db] text-center px-5 py-2 my-2 bg-[#1b2e4b] hover:bg-gray-700 rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110">

...
<div class="col-md-6 col-lg-6 col-xl-9 col-xxl-8">
                                        ...
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                ...
                                                <div class="crypt-buy">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend"> <span
                                                                class="input-group-text">{{ ct('Hand') }}</span>
                                                        </div>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend"> <span
                                                                ...
                                                                >
                                                                <span>Leverage: &nbsp;</span>
                                                                <span id="market-buy-range">100%</span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="crypt-sell">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend"><span
                                                                ...
                                                                >
                                                                <span>Leverage: &nbsp;</span>
                                                                <span id="market-sell-range">100%</span>
                                                            </span>
                                                        </div>
                                                        <div class="input-group-prepend">
                                                            <input type="range" min="1" max="100"
     ...
     <div class="crypt-gross-market-cap mt-4">
         ...
         <div class="col-md-6 col-lg-6 col-xl-3 col-xxl-2">
                <div class="crypt-market-status mt-4">
                    <div>
                        <ul class="nav nav-tabs">
                            <li role="presentation"><a href="#market-trading" class="active" data-toggle="tab">{{ ct('market trading') }}</a>
                            </li>
                            <li role="presentation"><a href="#history" data-toggle="tab">{{ ct('history') }}</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="market-trading">
                                <table class="table table-striped" id="market-trading-table">
                                    <thead>
                                        <tr>
                                            
                                            <th scope="col">{{ ct('Price') }}
                                            <br>
                                      <h5>   <div class="crypt-down" id="lasty-price">{{ $pair_info->close }}</div> </h5>                                           </th>
                                            <th scope="col">{{ ct('Volume') }} 
                                            <br>  <h5>- </h5> </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($market_trades as $trade)
                                            <tr>
                                                ...
                                                <td class="flash @if ($trade->takerSide == 'SELL') crypt-down @else crypt-up @endif"
                                                    data-flash="{{ rand(1, 50) }}">{{ $trade->price }}</td>
                                                <td>{{ $trade->amount }}</td>
                    ...
                    <div class="crypt-market-status">
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <a href="#active-orders" class="active"
                                        data-toggle="tab">{{ ct('Active Trades') }}</a></li>
                            </ul>
                            <div class="tab-content">
                                      ...
                                      <sub> Opening Time </sub> <br>
                                       ...
                                       <td><div style="text-align: center;">
                                                       <br>  <sub> Take Profit </sub><br>
                                                        ...
                                                        <td> <div style="text-align: right;"> <div class="@if (str()->contains(str_replace('%', '', $trade->leverage) * ((($pair_info->close + $trade->coinz) - $trade->price) * $trade->amount), '-')) crypt-down @else crypt-up @endif" id="las-price">
                                       {{ str_replace('%', '', $trade->leverage) * ((($pair_info->close + $trade->coinz) - $trade->price) * $trade->amount) }}</div>
                                                           <sub>Current Price</sub><br>
                                                            <div id="cur-price">{{ $pair_info->close + $trade->coinz }}</div>
                                                            <sub> Handling&nbsp;Fee </sub><br>
                                                            {{ ct(0) }}   <br>
                                        <a href=""
                                                                data-id="{{ Crypt::encryptString($trade->id) }}"
                                                                class="btn btn-primary rounded p-1 stop-trade">stop</a> </div>
                                       </td>

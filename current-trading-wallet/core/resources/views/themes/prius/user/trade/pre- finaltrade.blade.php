                    ...
                    <div class="crypt-market-status">
                        <div>
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="#closed-orders" class="active" data-toggle="tab">{{ ct('Closed Trades') }}</a>
                                </li>
             
                                <li role="presentation"><a href="#balance" data-toggle="tab">{{ ct('Trading Balance') }}</a></li> 
                                <li role="presentation"><a href="https://trading-wallet.net/user/trading/trade/{{ $symbol_1 }}/{{ $symbol_2 }}">{{ ct('Trading Section') }}</a></li>
                            </ul>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">{{ ct('Opening Price') }}</th>
                                                <th scope="col">{{ ct('Current Price') }}</th>
                                                <th scope="col">{{ ct('Profit') }}</th>
                                            ...
                                            <tbody>
                                                @foreach ($trades->where('status', '!=', 'active') as $trade)
                                                    <tr>
                                                         ...
                                                         <td> <div class="@if (str()->contains($trade->order_type, 'sell')) crypt-down @else crypt-up @endif">
                                                            ...
                                                            @endif
                                       {{ ct($trade->order_type) }} {{ $symbol_1 }}/{{ $symbol_2 }} X{{ ct($trade->amount) }}Hand </div>
                                      ...
                                      <sub> Opening Time </sub> <br>
                                                        {{ date('d.m.Y', $trade->trade_start) }} {{ date('H:i:s', $trade->trade_start) }} 
                                                        </td>
                                       </td>
                                       ...
                                       {{ $trade->profit }}</div>
                                                        ...
                                                        <td>
                                                            {{ $trade->price }}</td>
                                                            <td>{{ $trade->finalz }}</p></td>
                                                        
                                                        <td>  <p class="@if (str()->contains($trade->profit, '-')) crypt-down @else crypt-up @endif" id="las-price">
                                       {{ $trade->profit }}</p></td>

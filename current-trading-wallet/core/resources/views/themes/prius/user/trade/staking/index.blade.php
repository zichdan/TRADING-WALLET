...
<head class="crypt-dark">
    ...
    <title> Select Trading Coin | {{ websiteInfo('website_name') }}</title>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-5">
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <div class="crypt-mega-dropdown-menu"> <a href="https://trading-wallet.net/user/trading/trade/BTC/USDT"
                                        class="crypt-mega-dropdown-toggle">Trading Section</a>
                                            ...
                                            @if (str()->endsWith($price->symbol, 'ETH'))
                                                @if (file_exists(root_path() . 'public/assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_ETH', '', $price->symbol)) . '.svg'))
                                                    <tr>
                                                        ...
                                                        <td class="flash" data-flash="{{ rand(1, 2) }}">
                                                            <span
                                                                class="@if (str()->contains($price->dailyChange, '-')) crypt-down @else crypt-up @endif">
                                                                {{ $price->dailyChange }}%
                                                            </span>

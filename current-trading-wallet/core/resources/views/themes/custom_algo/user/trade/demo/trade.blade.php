...
<head class="crypt-dark">
    ...
    <meta name="author" content="support@tradingwallet.net">
    <meta name="author" content="support@tradingwallet.net">
...
<body class="crypt-dark" id="body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <div class="crypt-mega-dropdown-menu"> <a href=""
                                        class="crypt-mega-dropdown-toggle">{{ $symbol_1 . '/' . $symbol_2 }} <span
                                            style="background-color: red; padding: 5px; font-size: 11px; border-radius: 10px 0px 10px 0px">{{ ct('demo') }}</span></a>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <img class="crypt-star pr-1" alt="star"
                                                                src="{{ asset('public/assets/imgs/crypto-svg-icons/' . strtolower(str_replace('_USDT', '', $price->symbol)) . '.svg') }}"
                                                                width="15">
                                                            <a
                                                                href="{{ url('/user/trading/demo/' . str_replace('_', '/', $price->symbol)) }}">{{ str()->replace('_', '/', $price->symbol) }}</a>
                                                        </td>
                                                        <td>
                                                            <span class="d-block">
                                                                {{ $price->price }}
                    ...
                    <div class="">
                        <div class="crypt-boxed-area">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation"><a href="#limit" class="active" data-toggle="tab">{{ ct('Limit') }}</a>
                                </li>
                                <li role="presentation"><a href="#market" class=""
                                                ...
                                                <div class="crypt-buy">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><input type="checkbox"
                                                                ...
                                                                data-toggle="market-buy-tp">{{ ct('TP/SL') }}</span>
                                            ...
                                            <div class="crypt-buy-sell-form">
                                                ...
                                                <div class="crypt-sell">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"><input type="checkbox"
                                                                class="toggle-tp" checked
                                                                data-toggle="market-sell-tp">{{ ct('TP/SL') }}</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="crypt-buy-sell-form">
                                                ...
                                                <div class="crypt-buy">
                                                    ...
                                                    <div class="menu-green order-button" data-order="limit"
                                                        data-type="buy"><a href=""
                                                            class="crypt-button-green-full">{{ ct('Buy') }}</a>
                                                    </div>
                                                </div>
                                            ...
                                            <tbody>
                                                @foreach ($trades->where('status', '!=', 'active') as $trade)
                                                    <tr>
                                                        ...
                                                        <td>{{ $trade->leverage }}</td>
                                                        <td><a role="button"
                                                                class="btn @if ($trade->status == 'win') btn-success @else btn-danger @endif  rounded p-1">{{ ct($trade->status) }}</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
    ...
    <script>
            ...
            setInterval(function() {
                $('.flash').each(function(i, obj) {
                    ...
                    if (interval > flashTime) {
                        setTimeout(function() {
                            $('.flash:eq(' + i + ')').fadeOut(100).fadeIn(100).fadeOut(100)
                                .fadeIn(100);
                        }, time);
                        time += 1000;
        ...
        $('.order-button').on('click', function(e) {
            ...
            if (+amount < 0.000000001) {
                ...
                $.ajax({
                    url: "{{ route('user.trading.demo.trade-validate') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        order: order,
    ...
    <script>
        $('.stop-trade').on('click', function(e) {
            ...
            var id = $(this).data('id');
            $.ajax({
                url: "{{ route('user.trading.demo.end-trade') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                    id: id,

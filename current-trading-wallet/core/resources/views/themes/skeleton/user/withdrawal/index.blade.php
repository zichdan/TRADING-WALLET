            ...
            <div  >
                <div  >
                    <div  >
                        ...
                        <div>
                            <div>
                                <h2  >{{ formatAmount($total_withdrawals_value) }}</h2>
                            </div>
                            <div  >
                                <h4  >Total</h4>
                            </div>
                    ...
                    <div  >
                        ...
                        <div>
                            <div>
                                <h2  >{{ formatAmount($pending_withdrawals_value) }}</h2>
                            </div>
                            <div  >
                                <h4  >Pending</h4>
                            </div>
                    ...
                    <div  >
                        ...
                        <div>
                            <div>
                                <h2  >{{ formatAmount($approved_withdrawals_value) }}</h2>
                            </div>
                            <div  >
                                <h4  >Approved</h4>
                            </div>
                    ...
                    <div  >
                        ...
                        <div>
                            <div>
                                <h2  >{{ formatAmount($rejected_withdrawals_value) }}</h2>
                            </div>
                            <div  >
                                <h4  >Rejected</h4>
                            </div>

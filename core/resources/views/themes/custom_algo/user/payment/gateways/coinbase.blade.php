    ...
    <div class="w-full flex justify-center">
        <div class="w-11/12 md:w-2/3 rounded-sm bg-[#0e1726] text-[#d3d6df] p-3 md:p-10">
            ...
            <div class="w-full">
                ...
                <form method="POST" action="{{ route('gateway.coinbase.pay') }}" class="mt-4 mb-2">
                    @csrf
...
<form id="coinbase-cancel-form" action="{{ route('user.deposit.pay.manual.cancel') }}" method="POST">
    @csrf
</form>

    ...
    <nav class="w-full flex flex-col space-y-2 lg:space-y-3">
        ...
        @if (websiteInfo('id_verification') == 'enabled' && isAddonEnabled('kyc'))
            <a href="{{ route('user.id.status') }}"
                ...
                <div class="opacity-100 nav-text">
                    <span class="font-semibold">Identity Verification</span>
                </div>
            </a>
        @endif
        {{--  KYC --}}
        ...
        @if (websiteInfo('trader_mode') == 'enabled' && (isAddonEnabled('cryptotrading') || ownedTradingEnabled()))
         ...
         <a href="{{ route('user.trading.trade.trade', ['symbol1' => 'ETC', 'symbol2' => 'USDT']) }}"
                ...
                <div class="opacity-100 nav-text">
                    <span class="font-semibold">Trade</span>
                        ...
                        <a href="{{ route('user.trading.demo.trade', ['symbol1' => 'ETC', 'symbol2' => 'USDT']) }}" @if (request()->routeIs('user.trading.demo.*')) class="sidenav-link-active" @else class="sidenav-link" @endif>
<div class="opacity-100">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="opacity-100 nav-text">
                    <span class="font-semibold">Trading History</span>
                </div>
            </a>

            <a href="{{ route('user.trading.trade.bot', ['symbol1' => 'ETC', 'symbol2' => 'USDT']) }}"
        ...
        @if (isAddonEnabled('nft'))
            <div class="dropdown-with-caret" data-menu-id="150">
                <a href="#"
                    class="@if (request()->routeIs('user.nft*')) sidenav-link-active @else sidenav-link @endif justify-between">
                    ...
                    <div class="nav-text">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 text-right transition ease-in-out delay-150 the-caret" data-menu-id="150"
                ...
                <div class="@if (!request()->routeIs('user.nft*')) hidden @endif mt-2 pl-5 transition ease-in-out delay-150 the-menu"
                    data-menu-id="150">
                    <ul class="space-y-2 text-sm nav-text">
                        <li>
                            <a class="text-gray-400 hover:text-gray-500" href="{{ route('user.nft.mint') }}">Mint</a>
                        </li>
                        <li>
                            <a class="text-gray-400 hover:text-gray-500"
                                href="{{ route('user.nft.market-place.index', ['user_id' => user('id')]) }}">My NFTs</a>
                        </li>

                        <li>
                            <a class="text-gray-400 hover:text-gray-500"
                                href="{{ route('user.nft.market-place.index') }}">NFT Market</a>
                        </li>
...
{{--  Investment ends here --}}
        ...
        @if (isAddonEnabled('supportticket'))
            ...
            <div class="dropdown-with-caret" data-menu-id="9">
                <a href="https://trading-wallet.net/user/deposits/new"
                    class="@if (request()->routeIs('user.deposit.new')) sidenav-link-active @else sidenav-link @endif justify-between">
                    <div class="sidenav-link-inner">
                        <div class="opacity-100">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="@if (!request()->routeIs('user.wallets*')) hidden @endif mt-2 pl-5 transition ease-in-out delay-150 the-menu"
                ...
                <ul class="space-y-2 text-sm nav-text">
                    ...
                    <li>
                       ...
                       <li>
                        <a class="text-gray-400 hover:text-gray-500" href="{{ route('user.withdrawals.new') }}">Request</a>
                    </li>
                </ul>
            </div>
        </div>

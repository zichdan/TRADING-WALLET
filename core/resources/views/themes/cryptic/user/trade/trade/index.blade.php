@php
    $balance = [];
    foreach (ownedTradingWallets() as $wallet) {
        $bal = ownedTradingWalletFiatValue($wallet);
                            ...
                            <div class="w-full  rounded-md bg-[#0e1726] text-[#d3d6df] p-2 md:p-4 md:w-1/2">
                                <div
                                    ...
                                    <h2 class="bg-transparent text-[#ebedf2] font-medium capitalize">
                                        ...
                                        <br> {{ ct('User ID:') }} <b class="font-medium text-green-500">{{ user('account_id') }}</b>
                                    </h2>
                                    ...
                                    @foreach (ownedTradingWallets() as $wallet)
                                        <div
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="w-full flex justify-end bg-gray-500 p-2 rounded">
                                                    <h2 class="font-lg">{{ formatAmount(ownedTradingWalletFiatValue($wallet)) }}</h2>
                                                </div>
                                            </div>
                    ...
                    <div class="trade-section">
                        ...
                        <div class="w-full  rounded-md bg-[#0e1726] text-[#d3d6df] p-2 md:p-4">
                            <div
                                ...
                                <div class="mt-5"></div>
                                @if (ownedTradingWallets()->count() > 0)
                                    @foreach (ownedTradingWallets() as $wallet)
                                        <div

{{-- header  --}}
@include('themes.cryptic.includes.header')
{{-- end header --}}

<div class="min-h-screen w-full md:flex">

    {{-- sidebar --}}
    @include('themes.cryptic.includes.sidenav')
    {{-- End sidebar --}}
    ...
    <div class="pt-28 md:pt-0 mt-0 md:mt-36 w-full md:w-4/5" id="general-content">
        <div class="w-full md:w-10/12 md:ml-64 2xl:ml-1/5" id="general-content-section">
            ...
            {{--  notices --}}
            @include('themes.cryptic.includes.notice')
            {{--  notices --}}
...
{{-- footer --}}
@include('themes.cryptic.includes.footer')
{{-- End footer --}}